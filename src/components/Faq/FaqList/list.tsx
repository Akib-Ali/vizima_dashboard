...
const FaqList: FC<CityListProps> = ({ faqList, isLoading, handleUpdateModalOpen, handleDetailModal, handleDeleteModalOpen }) => {


    console.log("faq in listing", faqList, isLoading)
